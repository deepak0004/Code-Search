...
enum Planet 
{
	MERCURY(0.38), VENUS(0.91), EARTH(1.00), MARS(0.38), JUPITER(2.54), SATURN(1.08), URANUS(.91), NEPTUNE(1.19);
...
public class planets 
{
	public static void main(String[] args) 
	{
		...
		{
				double weightNew = weight*(p.relation);
				
				System.out.println("Your weight on "+p+" is "+weightNew+" kilograms."); //provided the input is also in kgs.
		}
