public enum Planet 
{
    ...
    {
    	return earthMass * GRAVITY_ON_SURFACE(); 	// method
    }
    public static void main(String[] args)
    {
        double earthWeight = Double.parseDouble(args[0]); 	// variables,function,structure
        double m = earthWeight/EARTH.GRAVITY_ON_SURFACE();
        for (Planet p : Planet.values()) 	// arguments
           System.out.printf("Your weight on %s is %f%n",p, p.surfaceWeight(m)); 	// arguments
    }
}
